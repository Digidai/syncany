...
Syncany 当前状态：刚 fork 自 EryouHao/zano、零用户、零生产数据、单人维护、未正式上线。
...
**基础设施已 provision**：
- D1: `syncany-staging` `8270b74b-13cb-4928-a0c3-f077ce52d1fe` (APAC/SIN)
- KV: `syncany-rate-limits` `5e0ef6f92b35449db0f76d80a69d9548`
...
| 2026-05-08 | 暂时不发 npm 包 | `@syncany/bridge`、`@syncany/cli` 等待 v1.0 再发 |
