...
export function AlertDialogFooter({
  ...
  // Unified footer (see DialogFooter for rationale): no border, no muted
  // background — the action row is part of the same surface as the panel
  // above. `variant` retained for API compat but currently unused.
  void variant;
  return (
    <div
      className={cn(
