...
// Separate manager for toasts anchored to a specific element (e.g. tooltip-style
// toasts that appear next to the triggering button). Used only when the caller
// renders <AnchoredToastProvider> *and* passes positionerProps.anchor on add().
// Standalone of the global toastManager so the two viewports don't share state.
